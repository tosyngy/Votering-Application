 ...
 * @author damhiesax
 */
public class AgentsDetails extends javax.swing.JFrame {
   ...
   int j;
    ...
    private void initComponents() {
        ...
        jButton4.setBounds(750, 430, 100, 27);
        ...
        jLabel9.setText("Agents Details");
        jPanel1.add(jLabel9);
        jLabel9.setBounds(370, 10, 170, 30);
    ...
    query="SELECT * FROM agent_reg,login where agent_reg.id=login.userid and login.status=0 ORDER BY login.id DESC";
    }else if(jComboBox1.getSelectedIndex()==2){
     query="SELECT * FROM agent_reg,login where agent_reg.id=login.userid and login.status=1  ORDER BY login.id DESC";
    }else{
    query="SELECT * FROM agent_reg,login where agent_reg.id=login.userid ORDER BY login.id DESC";
     }
    fetch(query);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AgentsDetails.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AgentsDetails().setVisible(true);
            }
        });
    }
...
void fetch(String query){
    ...
    j=0;
     dataSet = new DefaultTableModel();
        ...
        dataSet.addColumn("First Name");
        dataSet.addColumn("Othernames");
        dataSet.addColumn("Mobile No");
        dataSet.addColumn("Residential Add.");
        dataSet.addColumn("LocationBase");
        dataSet.addColumn("Pwd");
  ...
  try {
         dbcon.rs = dbcon.st.executeQuery(query);
           while (dbcon.rs.next()) { 
               Object[] data = new Object[]{++j,dbcon.rs.getString("agentid"),dbcon.rs.getString("sysid"),
                   dbcon.rs.getString("firstname"),dbcon.rs.getString("othername"),
               dbcon.rs.getString("mobile"),dbcon.rs.getString("address"),
               dbcon.rs.getString("baselocation"),dbcon.rs.getString("password"),
               dbcon.rs.getString("adminid"),dbcon.rs.getString("regdate"),
               dbcon.rs.getString("status")};
                dataSet.addRow(data);
            }
