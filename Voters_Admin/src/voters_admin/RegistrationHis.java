 ...
 * @author damhiesax
 */
public class RegistrationHis extends javax.swing.JFrame {
   ...
   int j;
    ...
    private void initComponents() {
        ...
        dateChooserCombo3.setBounds(300, 430, 110, 30);
        ...
        jButton4.setBounds(20, 480, 100, 27);
        ...
        jButton5.setBounds(560, 430, 70, 30);
        ...
        jLabel9.setText("Registration History");
        jPanel1.add(jLabel9);
        jLabel9.setBounds(240, 10, 210, 30);
        ...
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Fetch Param", "Registered ", "Update", "Issue card" }));
        jPanel1.add(jComboBox1);
        jComboBox1.setBounds(430, 430, 120, 30);
        ...
        jPanel1.add(jLabel2);
        jLabel2.setBounds(20, 410, 620, 60);
    ...
    String newquery;
        query="SELECT * FROM register_detaila where " ;
    if(jCheckBox1.isSelected()){
    newquery="SELECT * FROM register_detaila";
    }else{
      newquery=buildQuery();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(RegistrationHis.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
...
void fetch(String query){
   ...
   query+=" AND transactiontype like '"+"%"+jComboBox1.getSelectedItem().toString()+"%' ORDER BY id DESC ";
   }else{
    query+=" where transactiontype like '"+"%"+jComboBox1.getSelectedItem().toString()+"%' ORDER BY id DESC ";
   }
