 ...
 * @author damhiesax
 */
public class SysHis extends javax.swing.JFrame {
   ...
   int j;
    ...
    query="SELECT * FROM system where status=0 ORDER BY id DESC";
    }else if(jComboBox1.getSelectedIndex()==2){
     query="SELECT * FROM system where status=1 ORDER BY id DESC";
    }else{
    query="SELECT * FROM system ORDER BY id DESC";
     }
    fetch(query);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SysHis.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
...
void fetch(String query){
    ...
    j=0;
     dataSet = new DefaultTableModel();
        ...
        dataSet.addColumn("System Name");
        dataSet.addColumn("Maker");
        dataSet.addColumn("Serial No");
        dataSet.addColumn("Sys Details");
  ...
  try {
         dbcon.rs = dbcon.st.executeQuery(query);
           while (dbcon.rs.next()) { 
               Object[] data = new Object[]{++j,dbcon.rs.getString("systemid"),dbcon.rs.getString("name"),
               dbcon.rs.getString("maker"),dbcon.rs.getString("serial_no"),
               dbcon.rs.getString("systemdetails"),dbcon.rs.getString("regdate"),
